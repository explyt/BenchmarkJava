//Analysis results:
//Tool name: Usvm Results: [501, 89]
//Tool name: Semgrep Results: []
//Tool name: CodeQL Results: []
//Original file name: BenchmarkTest01090
//Original file CWE's: [89]  
//Mutation info: Insert template from templates/constructors/parentConstructor.tmt with index 0
//Expected: false
//Program:
/**
...
import org.owasp.benchmark.helpers.BaseClass;
import org.owasp.benchmark.helpers.DerivedClass;

import java.util.*;

@WebServlet(value = "/sqli-02/BenchmarkTest01090")
public class BenchmarkTest010903248 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        DerivedClass dc = new DerivedClass(request.getRequestedSessionId());
        param = dc.baseValue;
