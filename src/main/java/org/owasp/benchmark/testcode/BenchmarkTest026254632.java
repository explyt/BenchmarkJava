...
//Original file name: BenchmarkTest02625
//Original file CWE's: [89]  
//Mutation info: Insert template from templates/cycles/recursion.tmt with index 1
//Expected: true
//Program:
/**
...
public class BenchmarkTest026254632 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            queryString = func1(param.indexOf(queryString, ampersandLoc), sql);
