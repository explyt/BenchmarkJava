...
//Tool name: Usvm Results: [89, 113, 99]
...
//Mutation info: Insert template from templates/constructors/staticMethodInitializer.tmt with index 1
//Expected: true
//Program:
/**
...
public class BenchmarkTest001121469 extends HttpServlet {
        ...
        if (theCookies != null) {
            for (javax.servlet.http.Cookie theCookie : theCookies) {
                if (theCookie.getName().equals("BenchmarkTest00112")) {
                    ...
                    UtilityClass.DEFAULT_VALUE = param;
