...
//Original file name: BenchmarkTest01002
//Original file CWE's: [89]  
//Mutation info: Mutate using template from templates/cycles/while.tmt with index 1 -> Mutate using template from templates/cycles/while.tmt with index 3
//Expected: false
//Program:
/**
...
public class BenchmarkTest01002147 extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int index = userCookie.getVersion();
        ...
        if (theCookies != null) {
            for (javax.servlet.http.Cookie theCookie : theCookies) {
                if (theCookie.getName().equals("BenchmarkTest01002")) {
                    ...
                    while (theCookie.getVersion() >= request.getIntHeader(param)) {
                        if (4 >= 46) {
