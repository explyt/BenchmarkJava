...
//Mutation info: Mutate using template from templates/cycles/while.tmt with index 0 -> Mutate using template from templates/cycles/while.tmt with index 5
//Expected: false
//Program:
/**
...
public class BenchmarkTest01622619 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        while (request.getHeader(param) == response.encodeRedirectURL(param) && 0.2666801931168019 > 0.40215115835066817) {
