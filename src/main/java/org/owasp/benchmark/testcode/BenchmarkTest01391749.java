//Analysis results:
//Tool name: Usvm Results: [501]
//Tool name: Semgrep Results: [89]
//Tool name: CodeQL Results: [89]
//Original file name: BenchmarkTest01391
//Original file CWE's: [89]  
//Mutation info: Insert template from templates/constructors/factory.tmt with index 1
//Expected: true
//Program:
/**
...
public class BenchmarkTest01391749 extends HttpServlet {
...
FactoryExample fe = FactoryExample.createInstance(sql);
bar = fe.val;
try {
