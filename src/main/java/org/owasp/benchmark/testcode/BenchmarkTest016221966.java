...
//Mutation info: Insert template from templates/pathSensitivity/simpleIf.tmt with index 1
//Expected: false
//Program:
/**
...
public class BenchmarkTest016221966 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (0.4783598736846495 != 0.7358933554225531) {
            bar = "";
        }
        String sql = "{call " + bar + "}";
