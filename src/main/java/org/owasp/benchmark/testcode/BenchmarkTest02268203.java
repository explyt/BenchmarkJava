...
//Original file name: BenchmarkTest02268
//Original file CWE's: [89]  
//Mutation info: Insert template from templates/constructors/constructorWithCollections.tmt with index 1
//Expected: false
//Program:
/**
...
import org.owasp.benchmark.helpers.CollectionHolder;
import java.util.*;

@WebServlet(value = "/sqli-04/BenchmarkTest02268")
public class BenchmarkTest02268203 extends HttpServlet {
    ...
    private static String doSomething(HttpServletRequest request, String param)
        ...
        String bar = "safe!";
CollectionHolder ch = new CollectionHolder(bar);
param = ch.list.get(request.getIntHeader(bar));
