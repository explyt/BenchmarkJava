...
//Original file name: BenchmarkTest01222
...
public class BenchmarkTest012222320 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayHolder ah = new ArrayHolder(param);
        bar = ah.getValues()[bar.indexOf(param)];
